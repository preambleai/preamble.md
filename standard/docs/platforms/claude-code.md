...
```bash
curl -sSL https://raw.githubusercontent.com/preambleai/preamble.md/main/standard/scripts/install-claude-code.sh | bash
```

Or download directly:
```bash
curl -o preamble.md https://raw.githubusercontent.com/preambleai/preamble.md/main/standard/templates/claude-code.md
```
...
See complete example: [../../examples/claude-code/](../../examples/claude-code/)

## Template

View template: [../../templates/claude-code.md](../../templates/claude-code.md)
