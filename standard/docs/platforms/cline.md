...
```bash
curl -sSL https://raw.githubusercontent.com/preambleai/preamble.md/main/standard/scripts/install-cline.sh | bash
```

Or download directly:
```bash
curl -o preamble.md https://raw.githubusercontent.com/preambleai/preamble.md/main/standard/templates/cline.md
```
...
See complete example: [../../examples/cline/](../../examples/cline/)

## Template

View template: [../../templates/cline.md](../../templates/cline.md)
